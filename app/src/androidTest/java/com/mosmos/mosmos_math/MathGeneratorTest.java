...
public class MathGeneratorTest {
    ...
    public void test_substruction_all() {
        for (int i = 0; i < 100; i++) {
            ...
            mathProblem = mathGenerator.generateMathProblem(MathGenerator.OperationType.SUB_UNDER20);
    ...
    public void test_enum() {
        MathGenerator.OperationType operationType = MathGenerator.OperationType.ADD_SUM_UNDER10;
    ...
    public void testFraction() {
        for (int i = 0; i < 100; i++) {
            MathProblem mathProblem = mathGenerator.generateMathProblem(MathGenerator.OperationType.FRACT_EXTRACT_WHOLE);
            assertInRange(mathProblem.result.get(0), 1, 10);

            mathProblem = mathGenerator.generateMathProblem(MathGenerator.OperationType.FRACT_SIMPLE_ADD_SAME_DEN);
            ...
            mathProblem = mathGenerator.generateMathProblem(MathGenerator.OperationType.FRACT_SIMPLE_SUB_SAME_DEN);
            assertInRange(mathProblem.operands.get(0), 1, 20);
            assertInRange(mathProblem.operands.get(1), 1, 20);
            assertTrue(mathProblem.result.get(0) < mathProblem.result.get(1));
